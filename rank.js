...
function getWinner(pack){
    ...
    if(count == 1){
        console.log('Winner is : '+ranks.indexOf(maxRank));
    }else{
        if(maxRank == 5)   
            console.log('Winner is : '+getHighValue(pack,maxRank,ranks));            
        else
            console.log('Winner is : '+getMaxSumIndex(pack,maxRank,ranks));     
    }
